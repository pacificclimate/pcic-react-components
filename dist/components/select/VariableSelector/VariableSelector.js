...
const arrangeOptions = options => {
  return [{
    ...
    options: flow(filter(o => o.representative.multi_year_mean), sortBy('label'))(options)
  }, {
...
const makeMenuItem = Wrapper => props => React.createElement(Wrapper, props, props.data.representative.multi_year_mean ? multiYearIcon : timeSeriesIcon, ' ', props.data.label);
